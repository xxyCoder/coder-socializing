...
<template>
  <span class="mt-5 center" @click="handlerCollect">
    <svg v-if="is" class="mt-5" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
      <polygon points="10,0 13.1,6.2 20,7.7 15.2,12.3 16.2,20 10,16 3.8,20 4.8,12.3 0,7.7 6.9,6.2" fill="yellow" />
    </svg>
    <svg v-else class="mt-5" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
      <polygon points="10,0 13.1,6.2 20,7.7 15.2,12.3 16.2,20 10,16 3.8,20 4.8,12.3 0,7.7 6.9,6.2" stroke="#ffffff"
        stroke-width="1" />
    </svg>
    <span>{{ cnt }}</span>
  </span>
